              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(TextEditingController(text: "05/05/1945")),
                  ],
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(TextEditingController(text: "Perempuan")),
                  ],
                ),
              ),
            ],
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("Agama"),
                    _buildTextField(TextEditingController(text: "Islam")),
                  ],
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(TextEditingController(text: "A")),
                  ],
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(TextEditingController(text: "Indonesia")),
                  ],
                ),
              ),
            ],
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("Propinsi"),
                    _buildTextField(TextEditingController(text: "Jawa Timur")),
                  ],
                ),
              ),
            ],
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("Kota"),
                    _buildTextField(TextEditingController(text: "Malang")),
                  ],
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("Kode Pos"),
                    _buildTextField(TextEditingController(text: "65432")),
                  ],
                ),
              ),
            ],
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("No.Hp"),
                    _buildTextField(TextEditingController(text: "0987654321")),
                  ],
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("Email"),
                    _buildTextField(
                      TextEditingController(text: "elvirarosa@gmail.com"),
                    ),
                  ],
                ),
              ),
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("NIK"),
                    _buildTextField(
                      TextEditingController(text: "354567899762452"),
                    ),
                  ],
                ),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    _formLabel("NPWP"),
                    _buildTextField(TextEditingController(text: "53527738")),
                  ],
                ),
              ),
            ],
